...
export default function Header() {
  ...
  return (
    <div className="absolute bg-sky-400 w-full h-20">
      <div className="text-white text-2xl h-full flex items-center justify-between mx-auto md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl">
        <Link to="/">
          <RemixLogo />
        </Link>
